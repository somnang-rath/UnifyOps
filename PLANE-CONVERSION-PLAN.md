...
- [ ] Bulk operations (multi-select + bulk edit bar) — 7b, ធ្វើលើ issues page ដែល migrate រួច (គ្មាន URL surface)
- [ ] Layout ជា search param — 7b, `?layout=` លើ Tier W list routes (reserved ក្នុង ADR 0011 §4 រួចហើយ)
