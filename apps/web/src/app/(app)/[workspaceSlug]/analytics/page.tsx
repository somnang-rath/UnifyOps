...
export default function AnalyticsPage() {
  ...
  // The workspace comes from the URL, not the store: the `[workspaceSlug]`
  // layout has already resolved this slug (this query is cache-shared with it)
  // and set the store to match — but the URL stays authoritative (ADR 0011).
    ...
    <div className="flex flex-col gap-5">
      ...
      {isError ? (
        ...
        <EmptyState
          ...
          action={
            <Button size="sm" onClick={() => router.push(`/${slug}/issues?new=1`)}>
